...
describe('rendering', () => {
  ...
  it('renders the variable count', () => {
    const envWithVars: Environment = {
      ...ENV,
      variables: [
        { id: 'v1', enabled: true, key: 'baseUrl', initialValue: 'http://localhost', currentValue: 'http://localhost' },
      ],
    };
...
describe('EnvRow — variable editing', () => {
  const ENV_WITH_VAR: Environment = {
    id: 'env-test',
    name: 'Test Env',
    variables: [{ id: 'v1', enabled: true, key: 'BASE_URL', initialValue: 'http://localhost', currentValue: 'http://dev' }],
  };
