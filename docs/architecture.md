...
`git init ~/.reqlet/workspace` works out of the box — no extra configuration
needed. This layout is the foundation for Phase 4 git-based team sync
(push/pull to GitHub, GitLab, Gitea, or a self-hosted [reqlet-hub](#reqlet-hub)).
